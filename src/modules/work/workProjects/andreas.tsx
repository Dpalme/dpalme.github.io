...
export const AndreasPage = () => {
  ...
  return (
    ...
    >
      <div className="top-0 flex grow flex-col gap-8 md:sticky md:row-span-2 lg:row-span-1">
        <div className="flex flex-col gap-2">
          ...
          <PopInAnimation delay={0.8}>
            <p className="font-alt font-normal italic">ANDREAS</p>
          </PopInAnimation>
        </div>
        <ProjectLinks
      ...
      <TableOfContents />
      <div
        className="my-8 flex w-full grow flex-col gap-16 md:col-start-2
      md:mt-0 lg:col-start-auto"
      >
        <div className="">
          <PopInAnimation delay={0.4}>
            <h2
